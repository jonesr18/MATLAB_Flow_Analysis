classdef ColorMap < handle
    ...
    properties (Constant)
        ...
        COLORS = struct( ...
            ...
            'leaf',			struct('cm_top', [0.8, 1.0, 0.6], 'cm_mid', [0.3, 0.6, 0.0], 'cm_bot', [0.1, 0.2, 0.0]), ...
            'green',        struct('cm_top', [0.6, 1.0, 0.6], 'cm_mid', [0.0, 0.6, 0.0], 'cm_bot', [0.0, 0.2, 0.0]), ...
            'teal',         struct('cm_top', [0.6, 1.0, 0.8], 'cm_mid', [0.0, 0.6, 0.3], 'cm_bot', [0.0, 0.2, 0.1]), ...
            ...
            'redblue',      struct('cm_top', [1.0, 0.0, 0.0], 'cm_mid', [0.85, 0.85, 0.85], 'cm_bot', [0.0, 0.0, 1.0]), ...
