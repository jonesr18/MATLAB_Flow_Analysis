...
%----->        % ADDED BY BREANNA STILLO %
        if strcmp(class(get_mnemonic_value(['$P',num2str(i),'V'],fcsheader_main, mnemonic_separator)),'char')
            fcshdr.par(i).voltage = str2num(get_mnemonic_value(['$P',num2str(i),'V'],fcsheader_main, mnemonic_separator));
        end
%----->
