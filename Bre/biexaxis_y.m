...
%         fprintf('Axis correction... may take a little time...please wait.\n')
        ...
        LargeTickVals=lin2logicle([-1e3 -1e2 -1e1 -1e0 0 1e0 1e1 1e2 1e3 1e4 1e5 ]);
        set(hha1, ...
           'ticklength',[0.02 0.09], ...%            'xlim',lin2logicle([r T]),...
           'ylim',lin2logicle([r T]),...%            'xtick',LargeTickVals, ...
           'ytick',LargeTickVals,...%            'xticklabel',{},...
           'yticklabel',{'','','','','0','','','','10^{3}','10^{4}','10^{5}'},'TickDir','out',...
           'LineWidth',1.5,'box','off')
        ...
        set(hha2,'color','none', ...
            'XTick',[],'XTickLabel',{},...
            'YTick',lin2logicle(TickVals),'YTickLabel',{},...%             'xlim',lin2logicle([r T]),...
            'TickDir','out',...
            'ylim',lin2logicle([r T]),'LineWidth',0.75,...
            'Position',p1)
        ...
        set(hha3,'color','none', ...
            'XTick',[],'XTickLabel',{},...
            'YTick',[],'YTickLabel',{},...%             'xlim',lin2logicle([r T]),...
